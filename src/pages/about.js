    ...
    <section className={styles.about}>
      <div className={styles.aboutContainer}>
        <div className={styles.imageSection}>
          ...
          />
          <h2 className={styles.name}>Nguyen Thanh Dat</h2>
          <p className={styles.title}>Software Engineering Student</p>
        </div>
        ...
        <div className={styles.contentSection}>
          ...
          <div className={styles.aboutSection}>
            ...
            <div className={styles.skills}>
              ...
              <span className={styles.futureSkill}>MongoDB</span>             
            </div>
          </div>
          ...
          <div className={styles.aboutSection}>
            ...
            <p>🧠 2024: Master React, build real-world applications</p>
            <p>🔜 2025: Learn Node.js, Express and MongoDB, build RESTful APIs</p>
